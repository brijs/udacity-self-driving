...
curl https://raw.githubusercontent.com/brijs/udacity-self-driving/main/scripts/launch.json --output /home/workspace/.vscode/launch.json

# download User settings.json
curl https://raw.githubusercontent.com/brijs/udacity-self-driving/main/scripts/user_data_user_settings.json --output /home/workspace/.vscode/user-data/User/settings.json
